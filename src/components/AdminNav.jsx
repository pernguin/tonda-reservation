        ...
        {[
          ...
          href ? (
            <a
              ...
              className="px-4 py-3 text-xs tracking-widest uppercase font-medium border-b-2 shrink-0 border-transparent text-gray-400 hover:text-gray-600 transition-colors"
            >
              {label}
            </a>
          ) : (
